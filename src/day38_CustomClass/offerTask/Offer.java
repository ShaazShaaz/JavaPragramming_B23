...
public class Offer {
    ...
    public boolean hasBenefit, workFromHome,hasPTO,isFullTime;

    public void setInfo(String state, String city, String jobTitle, double salary, boolean hasBenefit, boolean workFromHome, boolean hasPTO, boolean isFullTime) {
        this.state = state;
        this.city = city;
